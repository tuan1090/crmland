<?php require "header.php"; ?>
	<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor text-center" id="kt_content">
		<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		<!-- begin:: Content -->
			<div class="warning-content" style="text-align:center;margin: auto;margin-top: 10%;">
				<h1 style="font-weight: 300;margin-bottom: 2rem">Tính năng đang trong quá trình hoàn thiện</h1>
				...
				<p style="font-size: 20px;margin:2rem 0">
				  Cám ơn bạn vì đã sử dụng hệ thống CRMLAND. <br />
				  Hiện tạichúng tôi đang nỗ nực để hoàn thiện tính năng <span class="kt-font-bold">Đồng bộ dữ liệu khách hàng với facebook ads form</span>.<br />
				</p>
				<p>
				  Sẽ sớm thôi, vì vậy đừng quên theo dõi mọi tin tức từ CRMLAND bạn nhé!
				</p>
			</div>
		<!-- end:: Content -->
		</div>

<?php require "header.php"; ?>
			        ...
			        <div class="kt-widget kt-widget--user-profile-1">
			            ...
			            <div class="kt-widget__body">
			                ...
			                <div class="kt-widget__items">
			                    ...
			                    <a href="demo6/history-pay.php" class="kt-widget__item kt-widget__item--active">
			                        <span class="kt-widget__section">
			                            <span class="kt-widget__icon">
			            ...
			            <div class="col-xl-12">
			                <div class="kt-portlet kt-portlet--height-fluid">
			                    <div class="kt-portlet__head">
			                        <div class="kt-portlet__head-label">
			                            <h3 class="kt-portlet__head-title">Lịch sử thanh toán</h3>
			                        </div>
			                    </div>
			                            ...
			                            <div class="kt-section kt-section--first">
			                                <div class="kt-section__body">
			                                	<p class="history-empty text-center my-5">
			                                		...
			                                		<h5 class="d-block my-4 text-center">Oh! Bạn chưa có khoản thanh toán nào</h5>
			                                	</p>
												  	...
												  	<tbody>
												  		<tr>
												    		...
												    		<td>Nạp tiền vào tài khoản</td>
												      		...
												      		<td>100.000</td>
												      		<td>1.100.000</td>												      		
												      		<td>Chuyển khoản qua tài khoản</td>
												      		<td><span class="kt-badge kt-badge--inline kt-badge--warning">Chờ phê duyệt</span></td>
												      		<td><a class="kt-badge kt-badge--inline kt-badge--warning" data-toggle="modal" data-target="#kt_invoice_order_modal">Yêu cầu xuất hóa đơn</a></td>
												    	</tr>
												    	<tr>
												    		<td>#333333</td>
												    		<td>15/09/2019</td>
												    		<td>Nạp tiền vào tài khoản</td>
												      		...
												      		<td><span class="kt-badge kt-badge--inline kt-badge--warning" data-toggle="modal" data-target="#kt_invoice_order_modal">Yêu cầu xuất hóa đơn</span></td>
												    	</tr>
	...
	<!--begin::Modal-->
	<div class="modal fade" id="kt_invoice_order_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Yêu cầu xuất hóa đơn dịch vụ</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true"></span>
					</button>
				</div>
				<div class="modal-body">
					<p>Để yêu cầu xuất hóa đơn cho đơn hàng số #333333, bạn vui lòng cung cấp các thông tin sau</p>
					<ul class="nav nav-tabs nav-tabs-line" role="tablist">
	                    <li class="nav-item">
	                        <a class="nav-link active" data-toggle="tab" href="#kt_invoice_default" role="tab">Mặc định</a>
	                    </li>
	                    <li class="nav-item">
	                        <a class="nav-link" data-toggle="tab" href="#kt_invoice_other" role="tab">Thông tin khác</a>
	                    </li>
	                </ul>
	                <div class="tab-content">
	                    <div class="tab-pane active" id="kt_invoice_default" role="tabpanel">
	                        <div class="mb-4 row">
                                <span class="col-xl-3 col-lg-3">Người mua hàng</span>
                                <div class="col-lg-9 col-xl-9">
                                    <span>Nguyễn Huy Tuân</span>
                                </div>
                            </div>
							<div class="mb-4 row">
                                <span class="col-xl-3 col-lg-3">Tên công ty : </span>
                                <div class="col-lg-9 col-xl-9">
                                    <span>Công ty cổ phần công nghệ bất động sản V-Tech</span>
                                </div>
                            </div>
                            <div class="mb-4 row">
                                <span class="col-xl-3 col-lg-3">Mã số thuế : </span>
                                <div class="col-lg-9 col-xl-9">
                                    <span>999999</span>
                                </div>
                            </div>
                            <div class="mb-4 row">
                                <span class="col-xl-3 col-lg-3">Địa chỉ : </span>
                                <div class="col-lg-9 col-xl-9">
                                    <span>Tầng 3, HPC Landmark 105, Hà Đông, Hà Nội</span>
                                </div>
                            </div>
                            <div class="mb-4 row">
                                <span class="col-xl-3 col-lg-3">Điện thoại : </span>
                                <div class="col-lg-9 col-xl-9">
                                    <span>0968168800</span>
                                </div>
                            </div>
                            <div class="mb-4 row">
                                <span class="col-xl-3 col-lg-3">Người đại diện : </span>
                                <div class="col-lg-9 col-xl-9">
                                    <span>Lương Khánh Ly</span>
                                </div>
                            </div>
                            <div class="row">
                                <span class="col-xl-3 col-lg-3">Chức vụ : </span>
                                <div class="col-lg-9 col-xl-9">
                                    <span>Tổng Giám đốc</span>
                                </div>
                            </div>
	                    </div>
	                    <div class="tab-pane" id="kt_invoice_other" role="tabpanel">
							<div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Người mua hàng</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" value="" placeholder="Người mua hàng">
                                </div>
                            </div>
							<div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Tên công ty</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" value="" placeholder="Tên công ty">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Mã số thuế</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" value="" placeholder="Mã số thuế">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Địa chỉ</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" value="" placeholder="Địa chỉ">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Điện thoại liên hệ</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" value="" placeholder="Điện thoại liên hệ">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Người đại diện</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" value="" placeholder="Người đại diện">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Chức vụ</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" value="" placeholder="Chức vụ">
                                </div>
                            </div>
	                    </div> 
	                </div>        
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-brand">Yêu cầu xuất hóa đơn</button>
				</div>
			</div>
		</div>
	</div>

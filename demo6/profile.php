			        ...
			        <div class="kt-widget kt-widget--user-profile-1">
			            ...
			            <div class="kt-widget__body">
			                ...
			                <div class="kt-widget__items">
			                    <a href="demo6/profile.php" class="kt-widget__item kt-widget__item--active">
			            ...
			            <div class="col-xl-12">
			                <div class="kt-portlet kt-portlet--height-fluid">
			                    <div class="kt-portlet__head">
			                        <div class="kt-portlet__head-label">
			                            <h3 class="kt-portlet__head-title">Thông tin tài khoản</h3>
			                        </div>
			                    </div>
			                                ...
			                                <div class="kt-section__body">
			                                    ...
			                                    <div class="form-group row">
			                                        ...
			                                        <div class="col-lg-9 col-xl-6">
			                                            <input type="text" class="form-control" value="" placeholder="Họ tên">
			                                        </div>
			                                    </div>
			                                    <div class="form-group row">
			                                    ...
			                                    <div class="form-group row">
			                                        ...
			                                        <div class="col-lg-9 col-xl-6">
			                                            <input type="text" class="form-control" value="" placeholder="Điện thoại">
			                                        </div>
			                                    </div>
			                                    <div class="form-group row">
			                                    ...
			                                    <div class="form-group row">
			                                        ...
			                                        <div class="col-lg-9 col-xl-6">
			                                            <input type="file" name="avatar" accept="image/*" aria-invalid="false">
			                                        </div>
			                                    </div>
			                                    <div class="kt-separator kt-separator--space-lg kt-separator--border-dashed"></div>
												<div class="kt-section__title text-center">Thông tin xuất hóa đơn</div>
												<div class="form-group row">
			                            ...
			                            <div class="kt-form__actions">
			                                <div class="row">
			                                    ...
			                                    <div class="col-lg-9 col-xl-9">
			                                        <button type="reset" class="btn btn-brand btn-bold">Lưu thay đổi</button>&nbsp;

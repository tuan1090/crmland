	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title">
				Danh sách chiến dịch gửi SMS marketing
			</h3>
		...
		<div class="kt-subheader__toolbar">
			<a href="demo6/sms-camp-create.php" class="btn btn-primary btn-bold">
...
<?php require "footer.php"; ?>
		...
		<script src="./assets/js/demo6/pages/crud/metronic-datatable/base/data-sms-camp.js" type="text/javascript"></script>
